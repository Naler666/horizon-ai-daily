...
class AIConfig(BaseModel):
    ...
    # Optional controls for reasoning-capable OpenAI-compatible providers.
    # DeepSeek V4 enables thinking by default, so explicitly setting this to
    # false keeps routine classification and summarization costs predictable.
